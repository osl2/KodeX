 ...
 */
class MorseCodeProcedureInformationTest {
  
  private MorseCodeProcedureInformation colorImageProcedureInformation;

  @BeforeEach
  void setUp() {
    colorImageProcedureInformation = new MorseCodeProcedureInformation();
  }
  ...
  @Test
  void testGetName() {
    assertEquals("Morse-Code", colorImageProcedureInformation.getName());
  }
